...
1) Give you some context to why this pull request was created.
2) Provide you with some links to help you understand what CodeQL and GitHub Advanced Security are.
3) Help you with some 

As a company, we are moving towards CodeQL for our static analysis tool. We didn't want to manually go and raise a pull request for every single repository, and we didn't expect you to have to go and manually create a pull request for every single repositor either. So here is a pull request for you to review and hopefully approve!
...
Hopefully, you should see a nice green status tick next to CodeQL within the status section of the pull request. However, if you haven't, that's understandable. We have taken a best guess approach at configuring CodeQL for you, but 1) we are still maturing and 2) codeql can differ repository by repository. 
...
If you need any more assistance, please don't hesitiate to get in contect with a member of the central GitHub team. We are here to help. 
